...
have no idea about how are \lstlisting{F[_]} or \lstlisting{G[_]} handling their
encapsulated state. As long as \lstlisting{hom} is a monad morphism, our
composed lens expresses that we can access or update the nested zip code from a
person, no matter the particular configuration where it is deployed.
